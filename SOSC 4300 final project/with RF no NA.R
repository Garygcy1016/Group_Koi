...
set.seed(100)
data.imputed <- rfImpute(monetary_gain ~ ., data = data, iter=6)
str(data.imputed)
...
ggsave("/Users/choyuching/Downloads/22_12_with RF no NAresult for logistical regression with random forest_deletedNAthenRF.pdf")